<?php
// source: C:\xampp\htdocs\git\seznam-obci/config/common.neon
// source: C:\xampp\htdocs\git\seznam-obci/config/services.neon
// source: array
...
class Container_3d88bc4d24 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Model\KrajRepository' => [['02']],
		'App\Model\OkresRepository' => [['03']],
		'App\Model\ObecRepository' => [['04']],
		...
		'App\Presenters\KrajPresenter' => [2 => ['application.3']],
		'App\Presenters\ObecPresenter' => [2 => ['application.4']],
		'App\Presenters\OkresPresenter' => [2 => ['application.5']],
	...
	public function createService02(): App\Model\KrajRepository
	{
		return new App\Model\KrajRepository($this->getService('database.default.explorer'));
	}


	public function createService03(): App\Model\OkresRepository
	{
		return new App\Model\OkresRepository($this->getService('database.default.explorer'));
	}


	public function createService04(): App\Model\ObecRepository
	{
		return new App\Model\ObecRepository($this->getService('database.default.explorer'));
	}
	...
	public function createServiceApplication__3(): App\Presenters\KrajPresenter
	{
		$service = new App\Presenters\KrajPresenter($this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__4(): App\Presenters\ObecPresenter
	{
		$service = new App\Presenters\ObecPresenter($this->getService('04'), $this->getService('02'), $this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\Presenters\OkresPresenter
	{
		$service = new App\Presenters\OkresPresenter($this->getService('03'), $this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\git\seznam-obci/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('C:\xampp\htdocs\git\seznam-obci\www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\git\seznam-obci/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\git\seznam-obci/temp/cache', $this->getService('cache.journal'));
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=seznam_obci;charset=utf8mb4',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/''/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_3d88bc4d24 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\git\seznam-obci/temp/cache/latte');
	...
	{
		return [
			'appDir' => 'C:\xampp\htdocs\git\seznam-obci\app',
			'wwwDir' => 'C:\xampp\htdocs\git\seznam-obci\www',
			'vendorDir' => 'C:\xampp\htdocs\git\seznam-obci\vendor',
			'rootDir' => 'C:\xampp\htdocs\git\seznam-obci',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\git\seznam-obci/temp',
		];
	}
