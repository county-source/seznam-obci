<?php
// source: C:\xampp\htdocs\seznam-obci/config/common.neon
// source: C:\xampp\htdocs\seznam-obci/config/services.neon
// source: array
...
class Container_d2fc9b4504 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\seznam-obci/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('C:\xampp\htdocs\seznam-obci\www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\seznam-obci/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\seznam-obci/temp/cache', $this->getService('cache.journal'));
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_d2fc9b4504 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\seznam-obci/temp/cache/latte');
	...
	{
		return [
			'appDir' => 'C:\xampp\htdocs\seznam-obci\app',
			'wwwDir' => 'C:\xampp\htdocs\seznam-obci\www',
			'vendorDir' => 'C:\xampp\htdocs\seznam-obci\vendor',
			'rootDir' => 'C:\xampp\htdocs\seznam-obci',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\seznam-obci/temp',
		];
	}
